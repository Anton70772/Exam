...
def Register():
    ...
    tk.Label(register_window, text="Введите логин:").grid(row=0, column=0)
    login_entry = Entry(register_window)
    login_entry.grid(row=0, column=1)

    tk.Label(register_window, text="Введите пароль:").grid(row=1, column=0)
    ...
    submit_button = Button(register_window, text="Зарегистрироваться", command=RegisterSubmit)
...
def Login():
    ...
    submit_button = Button(login_window, text="Войти", command=LoginSubmit)
    submit_button.grid(row=2, columnspan=2)
...
Button(root, text="Регистрация", command=Register, height=3, width=13).place(x=30, y=170)
Button(root, text="Авторизация", command=Login, height=3, width=13).place(x=250, y=170)
