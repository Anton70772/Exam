...
Button(root, text="Add", command=Add, height=3, width=13).place(x=650, y=130)
Button(root, text="Refresh", command=refreshtable, height=3, width=13).place(x=650, y=230)
Button(root, text="Delete", command=Delete, height=3, width=13).place(x=650, y=330)
Button(root, text="Edit", command=Edit, height=3, width=13).place(x=650, y=430)
