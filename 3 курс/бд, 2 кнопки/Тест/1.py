...
def Delete():
    ...
    try:
        sql = f"delete from new_table where id = {listBox.set(listBox.selection(),"#1")}"
        # val = (studid,)
...
# Button(root, text="Edit", command=Edit, height=3, width=13).place(x=660, y=130)

Button(root, text="Add", command=Add, height=3, width=13).place(x=650, y=100)
Button(root, text="Refresh", command=refreshtable, height=3, width=13).place(x=650, y=200)
Button(root, text="Delete", command=Delete, height=3, width=13).place(x=650, y=300)
Button(root, text="Edit", command=Edit, height=3, width=13).place(x=650, y=400)
